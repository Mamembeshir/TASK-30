                   ...
                   class="group flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm transition hover:shadow-md">
                    <div class="flex-1 p-5">
                        <div class="flex items-start justify-between gap-2">
                            <h3 class="font-semibold text-gray-900 group-hover:text-indigo-600">{{ $trip->title }}</h3>
                        ...
                        <div class="mt-3 flex items-center gap-4 text-sm text-gray-600">
                            ...
                            <span>{{ $trip->difficulty_level->label() }}</span>
                        </div>
                    </div>
                    <div class="flex items-center justify-between border-t border-gray-100 px-5 py-3">
                        <span class="text-sm font-medium text-gray-900">{{ $trip->formattedPrice() }}</span>
