<div class="max-w-lg mx-auto">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="mb-6 rounded-lg bg-gray-50 p-4">
            <p class="text-sm font-medium text-gray-700">Order: <?php echo e($order->plan->name); ?></p>
            <p class="text-sm text-gray-500">Amount: <?php echo e($order->formattedAmount()); ?></p>
        </div>
        ...
        <form wire:submit.prevent="submit" class="space-y-5">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['refundType'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex gap-3 pt-2">
                <a href="<?php echo e(route('membership.my')); ?>"
...
<?php /**PATH /var/www/html/resources/views/livewire/membership/refund-request.blade.php ENDPATH**/ ?>