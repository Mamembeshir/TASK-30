...
<?php $component->withAttributes([]); ?>
                <p class="text-xs font-medium uppercase tracking-wider text-[#9CA3AF]"><?php echo e($stat['label']); ?></p>
                <p class="mt-2 text-2xl font-display font-semibold text-[#111827]"><?php echo e($stat['value']); ?></p>
                <p class="mt-1 text-xs text-[#6B7280]"><?php echo e($stat['hint']); ?></p>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-start gap-3 py-2 border-b border-[#F1F4F8] last:border-b-0">
                    <div class="w-8 h-8 rounded-full bg-[#E8F4F8] flex items-center justify-center text-[#1B6B93] text-xs font-semibold flex-shrink-0">
                        <?php echo e(strtoupper(substr($entry->actor?->profile?->first_name ?? $entry->actor?->username ?? '?', 0, 1))); ?>

                    </div>
                    <div class="min-w-0 flex-1">
                        <p class="text-sm text-[#111827] truncate">
                            <span class="font-medium"><?php echo e($entry->actor?->profile?->fullName() ?? $entry->actor?->username ?? 'System'); ?></span>
                            <span class="text-[#6B7280]"><?php echo e($entry->action); ?></span>
                        </p>
                        <p class="text-xs text-[#9CA3AF]"><?php echo e($entry->created_at->diffForHumans()); ?></p>
                    </div>
                </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $upcomingTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('trips.show', $trip)); ?>"
                   class="flex items-start justify-between gap-3 py-2 border-b border-[#F1F4F8] last:border-b-0 hover:bg-[#F8FAFC] -mx-2 px-2 rounded">
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-medium text-[#111827] truncate"><?php echo e($trip->title); ?></p>
                        <p class="text-xs text-[#6B7280] truncate"><?php echo e($trip->destination); ?> · <?php echo e($trip->start_date->format('M j, Y')); ?></p>
                    </div>
                    <span class="text-xs font-medium text-[#1B6B93] flex-shrink-0">
                        <?php echo e($trip->available_seats); ?>/<?php echo e($trip->total_seats); ?> seats
                    </span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
