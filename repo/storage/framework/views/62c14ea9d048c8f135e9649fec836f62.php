<div class="max-w-lg mx-auto">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500"><?php echo e($plan->tier->label()); ?> &middot; <?php echo e($plan->duration_months); ?> month(s)</p>
        ...
        <div class="border-t border-gray-100 pt-4 mb-6">
            <div class="flex justify-between text-sm">
                ...
                <span class="text-xl font-bold text-gray-900"><?php echo e($plan->formattedPrice()); ?></span>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/livewire/membership/purchase-flow.blade.php ENDPATH**/ ?>