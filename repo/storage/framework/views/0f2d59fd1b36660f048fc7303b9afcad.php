...
<svg <?php echo e($attributes); ?> fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <?php echo $path; ?>

</svg>
<?php /**PATH /var/www/html/resources/views/components/sidebar-icon.blade.php ENDPATH**/ ?>